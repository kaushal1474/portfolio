      ...
      >
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            ...
            >
              <img src={link} alt="link" className="w-1/2 h-1/2 object-contain" style={{ filter: "contrast(0)" }} />
            </a>
          </div>
        </div>
        <div className="mt-5">
          <h3 className="text-white font-bold text-2xl">{name}
            {subtext && <span className="ml-1 text-secondary text-xl"> | {subtext}</span>}
          </h3>
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-3 text-secondary text-[17px] leading-[30px] max-w-3xl">
